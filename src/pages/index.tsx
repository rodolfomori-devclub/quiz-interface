  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <section className="w-full p-4 mt-2 flex-grow min-lg:max-w-[1063px] min-lg:mx-auto">
        <h3 className="text-violet-500 font-semibold text-lg min-md:text-2xl">QUIZ do Desafio da Gestão de Tráfego</h3>

        <p className="text-zinc-600 mt-2 text-sm min-md:text-lg">Seja muito bem-vindo(a) ao <b>QUIZ DO DESAFIO DA GESTÃO DE TRÁFEGO</b></p>

        <p className="text-zinc-600 mt-4 text-sm min-md:text-base">A finalidade deste <b>QUIZ</b> é, primeiro, te ajudar a absorver todo o conteúdo que eu dei nas aulas do <b>DESAFIO DA GESTÃO DE TRÁFEGO</b>, colocando seu conhecimento, recém adquirido em prática, segundo, parabenizar e bonificar aqueles que comprovarem ter aprendido tudo que foi ensinado. Por isso, quem acertar 70% (setenta por cento) ou mais neste <b>QUIZ</b>, vai concorrer ao Kit Gestão de Tráfego e, caso sorteado, poderá escolher qual prefere: Kit Gestão de Tráfego N° 01 <b>OU</b> Kit Gestão de Tráfego N° 02</p>

        <ul className="text-zinc-600 mt-4 space-y-2 text-sm min-md:text-base">
          <li><b>- Kit Gestão de Tráfego nº 01:</b> Computador + Iphone + Vaga na Comunidade Devclub;</li>
          <li><b>- Kit Gestão de Tráfego nº 02:</b> 10 mil reais para você investir em anúncios online + Vaga na Comunidade Devclub;</li>
        </ul>
        ...
        <div id="general-provisions" className="mt-6">
          ...
          <p className="text-zinc-600 text-sm min-md:text-base mt-6">É de exclusiva responsabilidade dos participantes responder, repassar, informar os seus dados pessoais para concorrer aos prêmios nos prazos previstos neste regulamento. A imprecisão das informações exigidas para que os participantes possam concorrer regularmente aos prêmios implicará, a critério da equipe do especialista Devclub, a desclassificação do participante.</p>
